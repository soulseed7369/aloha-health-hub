    ...
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="prose prose-stone max-w-none">
        ...
        <p>
          ...
          and platform operated by <strong>Hawaii Wellness</strong> ("we," "us," or "our").
        ...
        <p>
          ...
          owned by Hawaii Wellness. You may not reproduce, distribute, or create derivative
          works without our written permission.
        </p>
        <p>
          By submitting listing content (text, photos, etc.), you grant Hawaii Wellness a
        ...
        <p>
          TO THE MAXIMUM EXTENT PERMITTED BY LAW, HAWAII WELLNESS SHALL NOT BE LIABLE FOR
        ...
        <p>
          You agree to indemnify and hold harmless Hawaii Wellness, its officers, employees,
        ...
        <address className="not-italic">
          <strong>Hawaii Wellness</strong><br />
