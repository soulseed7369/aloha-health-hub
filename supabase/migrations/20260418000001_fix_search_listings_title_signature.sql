-- Corrective migration: the 20260418000000 version changed the parameter
-- signature (renamed p_page/p_page_size -> p_limit/p_offset, and swapped
-- p_listing_type/p_session_type positions). The client hook calls the RPC
-- with named args p_page/p_page_size, so the directory broke.
--
-- This migration restores the ORIGINAL signature from 20260328000002
-- while keeping the new `title` column in the returned table.
